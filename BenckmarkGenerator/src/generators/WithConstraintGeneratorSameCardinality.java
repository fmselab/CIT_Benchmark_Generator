...
public class WithConstraintGeneratorSameCardinality extends WithoutConstraintGeneratorSameCardinality{
	...
	public Model generate(Category type) {
		...
		int oldNParamsMax = WithoutConstraintGeneratorSameCardinality.N_PARAMS_MAX;
		int oldNParamsMin = WithoutConstraintGeneratorSameCardinality.N_PARAMS_MIN;		
		WithoutConstraintGeneratorSameCardinality.N_PARAMS_MAX = N_PARAMS_MAX;
		WithoutConstraintGeneratorSameCardinality.N_PARAMS_MIN = N_PARAMS_MIN;		
		Model m = super.generate(type);
		WithoutConstraintGeneratorSameCardinality.N_PARAMS_MAX = oldNParamsMax;
		WithoutConstraintGeneratorSameCardinality.N_PARAMS_MIN = oldNParamsMin;	
