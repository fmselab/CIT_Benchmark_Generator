...
public class IWCT2025SIExperiments_ComparisonSearchNoSearch_RQ2 {
	...
	public void solvable(Track track)
		...
		for (int i = 0; i < REPETITIONS; i++) {
			...
			writer.append(config.TRACK.name() + ";SOLVABILITY;" + countOriginal + ";" + timeOriginalApproach + ";BENCIGEN;\n");
			writer.flush();
			...
			writer.append(config.TRACK.name() + ";SOLVABILITY;" + countSearch + ";" + timeSearchBasedApproach + ";BENCIGENSMO;\n");
	...
	public void testRatio(Track track)
		...
		for (int i = 0; i < REPETITIONS; i++) {
			...
			timeOriginalApproach = end - start;
			writer.append(config.TRACK.name() + ";TESTRATIO;" + countOriginal + ";" + timeOriginalApproach + ";BENCIGEN;\n");
			writer.flush();
			config.USE_SEARCH = true;
			int countSearch = 0;
			start = System.currentTimeMillis();
